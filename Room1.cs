...
namespace CrossPlatformDesktopProject.RoomManagement
{
    class Room1 : iRoom
	{
		...
		public List<IBlock> Doors {get; set; }
		...
		void AddDoor(XElement doorObject)
		{
			...
			{
				Doors.Add(new DoorClosed(new Vector2(500,350)));
			}
			if ((string)doorObject.Element("DoorType") == "Open")
			{
				Doors.Add(new DoorOpen(new Vector2(400,350)));
			}
			if ((string)doorObject.Element("DoorType") == "Locked")
			{
				Doors.Add(new DoorLocked(new Vector2(400,550)));
			}
			if ((string)doorObject.Element("DoorType") == "Bombed")
			{
				Doors.Add(new DoorBombed(new Vector2(500,550)));
			}
		}
