...
namespace Sprint0
{
    class GameOverKeyboardController : IController
    {
        private Game1 game;
        ...
        public GameOverKeyboardController(Game1 game)
        {
            this.game = game;
            controllerMappings = new Dictionary<Keys, ICommand>();
            RegisterCommand(Keys.Escape, new CommandReset(game));
            RegisterCommand(Keys.Enter, new CommandReset(game));
